...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Fabrice Malanga</title>
        <meta
          name="description"
          content="Fabrice Malanga est Un développeur web et web mobile de Kinshasa-RD Congo. Teddy, un développeur fullstack, peut concevoir des systèmes informatiques, développer des solutions web, des applications mobiles et bien plus. "
        />
